...
namespace DAL
{
    public class BezoekerDAL : IBezoekerDAL
    {
        public List<Bezoeker> GetAllBezoekers()
        {
            ...
            bezoekers.Add(new Bezoeker("Kind1", new DateTime(2014, 2, 2), new DateTime(2021, 12, 2)));
            bezoekers.Add(new Bezoeker("Kind2", new DateTime(2014, 2, 2), new DateTime(2021, 12, 2)));
